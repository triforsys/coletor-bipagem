...
export default function Ocorrencia() {
  ...
  const handleSubmit = async (row) => {
    try {
      ...
      await handleIntegration.mutateAsync(data);
    } catch (err) {
      console.error('err', err);
      toast.error('Erro inesperado, contate o administrador!');
    }
      ...
      <Menu>
        <div className="max-w-screen-2xl min-h-max mx-auto">
          <div className="flex justify-center mb-6">
            <h1 className="font-semibold">API Ocorrência</h1>
          </div>
          <div className="flex flex-wrap rounded-lg bg-white p-3 drop-shadow-2xl space-x-2  ">
            <Tooltip message="Data Emissão Inicial">
              <div className="mb-1">
                <DatePiker
                  className="w-[200px]"
            ...
            <Tooltip message="Data Emissão Final">
              <div className="mb-1">
                <DatePiker
                  className="w-[200px]"
            ...
            <Tooltip message="Data Vencto Inicial ">
              <div className="mb-1">
                <DatePiker
                  className="w-[200px]"
                  date={dataInicial}
            ...
            <Tooltip message="Data Vencto Final">
              <div className="mb-1">
                <DatePiker
                  className="w-[200px]"
                  date={dataFinal}
